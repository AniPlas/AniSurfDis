...
static void c_emxFreeStruct_coder_internal_(c_coder_internal_anonymous_func
  *pStruct);
static void d_emxInitStruct_coder_internal_(const emlrtStack *sp,
  c_coder_internal_anonymous_func *pStruct, const emlrtRTEInfo *srcLocation,
  boolean_T doPush);
static void emxCopyMatrix_creal_T(creal_T dst[3], const creal_T src[3]);
static void emxCopyMatrix_creal_T1(creal_T dst[9], const creal_T src[9]);
static void emxCopyMatrix_real_T(real_T dst[81], const real_T src[81]);
static void emxCopyMatrix_real_T1(real_T dst[3], const real_T src[3]);
static void emxCopyMatrix_real_T2(real_T dst[25], const real_T src[25]);
static void emxCopyMatrix_real_T3(real_T dst[900], const real_T src[900]);
...
static void d_emxInitStruct_coder_internal_(const emlrtStack *sp,
  ...
  boolean_T doPush)
{
  emxInitStruct_cell_2(sp, &pStruct->tunableEnvironment, srcLocation, doPush);
}
...
{
  d_emxInitStruct_coder_internal_(sp, &pStruct->contents, srcLocation, doPush);
}

void d_emxFreeStruct_coder_internal_(coder_internal_ref *pStruct)
{
  c_emxFreeStruct_coder_internal_(&pStruct->contents);
}

void emxCopyStruct_cell_2(const emlrtStack *sp, cell_2 *dst, const cell_2 *src,
  const emlrtRTEInfo *srcLocation)
{
  dst->f1 = src->f1;
  dst->f2 = src->f2;
  emxCopyMatrix_real_T(dst->f3, src->f3);
  emxCopyMatrix_creal_T(dst->f4, src->f4);
  emxCopyMatrix_real_T1(dst->f5, src->f5);
  emxCopyMatrix_real_T1(dst->f6, src->f6);
  emxCopyMatrix_creal_T1(dst->f7, src->f7);
  emxCopyMatrix_creal_T1(dst->f8, src->f8);
  emxCopyMatrix_real_T(dst->f9, src->f9);
  emxCopyMatrix_creal_T(dst->f10, src->f10);
  emxCopyMatrix_real_T1(dst->f11, src->f11);
  emxCopyMatrix_real_T1(dst->f12, src->f12);
  emxCopyMatrix_creal_T1(dst->f13, src->f13);
  emxCopyMatrix_creal_T1(dst->f14, src->f14);
  emxCopyMatrix_real_T(dst->f15, src->f15);
  emxCopyMatrix_creal_T(dst->f16, src->f16);
  emxCopyMatrix_real_T1(dst->f17, src->f17);
  emxCopyMatrix_real_T1(dst->f18, src->f18);
  emxCopyMatrix_creal_T1(dst->f19, src->f19);
  emxCopyMatrix_creal_T1(dst->f20, src->f20);
  emxCopyMatrix_real_T(dst->f21, src->f21);
  emxCopyMatrix_creal_T(dst->f22, src->f22);
  emxCopyMatrix_real_T1(dst->f23, src->f23);
  emxCopyMatrix_real_T1(dst->f24, src->f24);
  emxCopyMatrix_creal_T1(dst->f25, src->f25);
  emxCopyMatrix_creal_T1(dst->f26, src->f26);
  emxCopyMatrix_real_T(dst->f27, src->f27);
  emxCopyMatrix_creal_T(dst->f28, src->f28);
  emxCopyMatrix_real_T1(dst->f29, src->f29);
  emxCopyMatrix_real_T1(dst->f30, src->f30);
  emxCopyMatrix_creal_T1(dst->f31, src->f31);
  emxCopyMatrix_creal_T1(dst->f32, src->f32);
  emxCopyMatrix_real_T2(dst->f33, src->f33);
  dst->f34 = src->f34;
  emxCopy_real_T(sp, &dst->f35, &src->f35, srcLocation);
  emxCopy_real_T(sp, &dst->f36, &src->f36, srcLocation);
  emxCopy_real_T(sp, &dst->f37, &src->f37, srcLocation);
  emxCopyMatrix_real_T3(dst->f38, src->f38);
  emxCopyMatrix_real_T3(dst->f39, src->f39);
  emxCopyMatrix_real_T3(dst->f40, src->f40);
  emxCopyMatrix_real_T1(dst->f41, src->f41);
  dst->f42 = src->f42;
  emxCopy_real_T(sp, &dst->f43, &src->f43, srcLocation);
  emxCopy_real_T(sp, &dst->f44, &src->f44, srcLocation);
}
...
void emxFreeStruct_cell_2(cell_2 *pStruct)
{
  emxFree_real_T(&pStruct->f35);
  emxFree_real_T(&pStruct->f36);
  emxFree_real_T(&pStruct->f37);
  emxFree_real_T(&pStruct->f43);
  emxFree_real_T(&pStruct->f44);
}
...
void emxInitStruct_cell_2(const emlrtStack *sp, cell_2 *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->f35, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->f36, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->f37, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->f43, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->f44, 2, srcLocation, doPush);
}
...
/* End of code generation (stress_emxutil.c) */
