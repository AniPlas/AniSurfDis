 ...
 * stress_I.h
 *
 * Code generation for function 'stress_I'
 *
 */
...
extern void stress_I(const emlrtStack *sp, const emxArray_real_T *x, real_T x1,
                     ...
                     [81], const creal_T P_SU[3], const real_T P_SU_Re[3], const
                     real_T P_SU_Im[3], const creal_T A_SU[9], const creal_T
                     B_SU[9], const real_T C_SL[81], const creal_T P_SL[3],
                     const real_T P_SL_Re[3], const real_T P_SL_Im[3], const
...
/* End of code generation (stress_I.h) */
