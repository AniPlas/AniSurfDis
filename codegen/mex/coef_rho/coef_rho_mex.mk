...
MAKEFILE = coef_rho_mex.mk

include coef_rho_mex.mki
...
SRC_FILES =  \
	...
	P_R.c \
	Q_R.c \
	_coder_coef_rho_info.c \
	_coder_coef_rho_api.c \
	_coder_coef_rho_mex.c \
	coef_rho_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = coef_rho_mex
...
SYS_INCLUDE += -I "/home/xiaolei/Documents/ImageStress/codegen/mex/coef_rho"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/coef_rho/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/coef_rho/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/coef_rho/%.cu
	$(CC) $(CCFLAGS) "$<"
