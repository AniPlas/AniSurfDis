...
MAKEFILE = rho_distri_mex.mk

include rho_distri_mex.mki
...
SRC_FILES =  \
	...
	xgeqp3.c \
	rho.c \
	_coder_rho_distri_info.c \
	_coder_rho_distri_api.c \
	_coder_rho_distri_mex.c \
	rho_distri_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = rho_distri_mex
...
SYS_INCLUDE += -I "/home/xiaolei/Documents/ImageStress/codegen/mex/rho_distri"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/rho_distri/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/rho_distri/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/xiaolei/Documents/ImageStress/codegen/mex/rho_distri/%.cu
	$(CC) $(CCFLAGS) "$<"
